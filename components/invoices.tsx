    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12">
          <div className="text-muted-foreground text-lg">Loading invoices...</div>
        </div>
      </div>
    )
  }
  ...
  if (error) {
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-12">
          <div className="text-red-500 text-lg mb-4">Error loading invoices: {error}</div>
              ...
              <div className="flex items-center space-x-3 p-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg border border-primary/20">
                ...
                <div className="ml-auto flex space-x-2">
                  ...
                  <Badge variant="outline" className="bg-red-50 text-red-700 border-red-200">
                    {clientInvoices.filter((i) => isOverdue(i.due_date, i.status)).length} Overdue
                  </Badge>
                </div>
              </div>
                    ...
                    >
                      ...
                      <CardContent className="space-y-3 flex-1 flex flex-col">
                        ...
                        <div className="flex items-center text-sm text-muted-foreground flex-shrink-0">
                          ...
                          <span>{Array.isArray(invoice.items) ? invoice.items.length : 0} item(s)</span>
                        </div>
